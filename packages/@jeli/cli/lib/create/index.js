...
const { getPackageManagerList} = require('../utils/packageManager');
 ...
 * 
 * @param {*} jeliWorkSpace 
 * @param {*} blankWorkSpace 
 * @param {*} name 
 * @param {*} targetDir 
 * @param {*} projecttExists 
 */
const coreCreate = async(jeliWorkSpace, blankWorkSpace, name, targetDir, projectExists) => {
